    ...
    private WorkoutLab(Context context){
        ...
        mDatabase= new WorkoutBaseHelper(mContext).getWritableDatabase();
            if(getWorkouts().size()<1) {
                ...
                WOD3.setExercise(new String[]{"rounds”,“Burpees”,”Squats”,”Situps”,”Pullups”,“ min rest"});
                WOD3.setReps(new int[]{1,10,15,10,5,2});
                WOD3.setWorkoutNum(40);
                addWorkout(WOD3);
                Workout WOD4 = new Workout();
                WOD4.setCompleted(false);
                WOD4.setExercise(new String[]{ "rounds”,”Broad Jumps”,”V-Ups”,”Glute Bridges”,”Close Grip Pushups”,”min rest" });
                WOD4.setReps(new int[]{1,6,6,6,6,1});
                WOD4.setWorkoutNum(24);
                addWorkout(WOD4);
                Workout WOD5 = new Workout();
                WOD5.setCompleted(false);
                WOD5.setExercise(new String[]{ "rounds”,”Squats”,”Dips”,”Pullups”,”Lunges/Leg”,”Flutter Kicks/Leg"});
                WOD5.setReps(new int[]{1,6,8,4,8,6});
                WOD5.setWorkoutNum(32);
                addWorkout(WOD5);
                Workout WOD6 = new Workout();
                WOD6.setCompleted(false);
                WOD6.setExercise(new String[]{ "rounds”,”Pullups”,”Burpees”,”sit ups”,”Squats”,”min rest"});
                WOD6.setReps(new int[]{1,5,10,15,20,3});
                WOD6.setWorkoutNum(50);
                addWorkout(WOD6);
                Workout WOD7 = new Workout();
                WOD7.setCompleted(false);
                WOD7.setExercise(new String[]{"rounds”,”Mountain Climbers”,”Pushups”,”Pullups”,”m Bear Crawl”,”Situps"});
                WOD7.setReps(new int[]{1,20,10,5,10,20});
                WOD7.setWorkoutNum(65);
                addWorkout(WOD7);
                Workout WOD8 = new Workout();
                WOD8.setCompleted(false);
                WOD8.setExercise(new String[]{"Min AMRAP”,”Pushups”,”Squats”,”Burpees”,”Lunges/Leg”,”Situps"});
                WOD8.setReps(new int[]{1,5,10,5,10,15});
                WOD8.setWorkoutNum(45);
                addWorkout(WOD8);
                Workout WOD9 = new Workout();
                WOD9.setCompleted(false);
                WOD9.setExercise(new String[]{ "Min AMRAP”,”Burpees”,”Squats”,”Situps”,”Pullups”,”Lunges/Leg"});
                WOD9.setReps(new int[]{1,10,15,10,5,16});
                WOD9.setWorkoutNum(56);
                addWorkout(WOD9);
                Workout WOD10 = new Workout();
                WOD10.setCompleted(false);
                WOD10.setExercise(new String[]{"Min AMRAP”,”Squats”,”Dips”,”Pullups”,”Lunges/Leg”,”Flutter Kicks/Leg"});
                WOD10.setReps(new int[]{1,6,8,4,8,6});
                ...
                WOD11.setReps(new int[]{1,5,10,15,20,10});
                WOD11.setWorkoutNum(65);
                addWorkout(WOD11);
                Workout WOD12 = new Workout();
                WOD12.setCompleted(false);
                WOD12.setExercise(new String[]{"Min AMRAP”,”Squats”,”Situps”,”Pushups”,”Lunges/Leg”,”Pullups"});
                WOD12.setReps(new int[]{1,25,20,15,10,5});
                ...
                WOD13.setReps(new int[]{1,5,10,15,10,5});
                WOD13.setWorkoutNum(45);
                addWorkout(WOD13);
                Workout WOD14 = new Workout();
                WOD14.setCompleted(false);
                WOD14.setExercise(new String[]{"rounds”,”Lunges/Leg”,”Pushups”,”V-ups”,”Pullups”,”Burpees"});
                WOD14.setReps(new int[]{1,10,8,6,4,2});
                WOD14.setWorkoutNum(40);
                addWorkout(WOD14);
                Workout WOD15 = new Workout();
                WOD15.setCompleted(false);
                WOD15.setExercise(new String[]{"rounds”,”Pushups”,”Dips”,”Pullups”,”Burpees”,”min rest"});
                WOD15.setReps(new int[]{1,5,5,5,5,2});
                WOD15.setWorkoutNum(22);
                addWorkout(WOD15);
                Workout WOD16 = new Workout();
                WOD16.setCompleted(false);
                WOD16.setExercise(new String[]{ "rounds”,”Squats”,”Situps”,”Pushups”,”Lunges/Leg”,”Pullups"});
                WOD16.setReps(new int[]{1,25,20,15,10,5});
                WOD16.setWorkoutNum(85);
                addWorkout(WOD16);
                Workout WOD17 = new Workout();
                WOD17.setCompleted(false);
                WOD17.setExercise(new String[]{ "rounds”,”Pushups”,”Dips”,”Pullups”,”Burpees”,”min rest"});
                WOD17.setReps(new int[]{1,5,5,5,5,2});
                WOD17.setWorkoutNum(22);
                addWorkout(WOD17);
                Workout WOD18 = new Workout();
                WOD18.setCompleted(false);
                WOD18.setExercise(new String[]{"rounds”,”Squats”,”Lunges/Leg”,”Glute Bridges”,”broad Jumps”,”min rest"});
                WOD18.setReps(new int[]{1,5,5,5,5,2});
